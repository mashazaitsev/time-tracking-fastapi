...
export const ProjectSummarySchema = {
    ...
    type: 'object',
    required: ['project_id', 'project_name', 'total_minutes'],
    title: 'ProjectSummary',
    description: 'Purpose: Per-project aggregated time summary'
} as const;
...
export const TimeEntryCreateSchema = {
    ...
    type: 'object',
    required: ['project_id', 'date', 'duration_minutes'],
...
export const TimeEntryPublicSchema = {
    ...
    type: 'object',
    required: ['project_id', 'date', 'duration_minutes', 'id', 'owner_id'],
    title: 'TimeEntryPublic',
    description: 'Purpose: TimeEntry response schema with owner reference'
} as const;
...
export const TimeSummarySchema = {
    properties: {
        total_minutes: {
            type: 'integer',
            title: 'Total Minutes'
    ...
    type: 'object',
    required: ['total_minutes', 'by_project'],
    title: 'TimeSummary',
    description: 'Purpose: Aggregated time summary across all projects for a user'
} as const;
