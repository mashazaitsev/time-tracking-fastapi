# SOP_STEP: Validate and Document Implementation

step_name: validate_and_document_implementation

# Codebase Summary

## Overview

> This SOP MUST be applied during the **research_relevant_information** step (Step 4) or **requirements_clarification** step (Step 3) to understand existing codebase structure and patterns.
